...
@section('content')
    <ul class="container__itemList ">
            <li class="itemList showList" id ="{{ $item ->id_embroidery_40x40 }}" data-price ="{{ $item ->price_embroidery_40x40 }}" data-name="{{ $item ->name_embroidery_40x40 }}" data-img="{{ $item ->imageMain_embroidery_40x40 }}" data-article="{{ $item ->article_embroidery_40x40 }}" data-category="embroidery_40x40" data-id="{{ $item ->id_embroidery_40x40 }}"> 
                <div class="imgGalery">
