...
@section('content')
    <ul class="container__itemList ">
            <li class="itemList showList" id ="{{ $item ->id_embroidery_40x50 }}" data-price ="{{ $item ->price_embroidery_40x50 }}" data-name="{{ $item ->name_embroidery_40x50 }}" data-img="{{ $item ->imageMain_embroidery_40x50 }}" data-article="{{ $item ->article_embroidery_40x50 }}" data-category="embroidery_40x50" data-id="{{ $item ->id_embroidery_40x50 }}"> 
                <div class="imgGalery">
