...
@section('content')
    <ul class="container__itemList ">
            <li class="itemList showList" id ="{{ $item ->id_diamond_20x30 }}" data-price ="{{ $item ->price_diamond_20x30 }}" data-name="{{ $item ->name_diamond_20x30 }}" data-img="{{ $item ->imageMain_diamond_20x30 }}" data-article="{{ $item ->article_diamond_20x30 }}"data-category="diamond_20x30" data-id="{{ $item ->id_diamond_20x30 }}"> 
                <div class="imgGalery">
