...
@section('content')
    <ul class="container__itemList">
        @foreach($projects as $project)
            <li class="itemList mainList" id ="{{ $project ->id_embroidery_40x50 }}" data-price ="{{ $project ->price_embroidery_40x50 }}" data-name="{{ $project ->name_embroidery_40x50 }}" data-img="{{ $project ->imageMain_embroidery_40x50 }}" data-article="{{ $project ->article_embroidery_40x50 }}" data-category="embroidery_40x50" data-id="{{ $project ->id_embroidery_40x50 }}">
                <div>
