...
@section('content')
    <ul class="container__itemList">
        @foreach($projects as $project)
            <li class="itemList mainList" id ="{{ $project ->id_diamond_equal_40x50 }}" data-price ="{{ $project ->price_diamond_equal_40x50 }}" data-name="{{ $project ->name_diamond_equal_40x50 }}" data-img="{{ $project ->imageMain_diamond_equal_40x50 }}" data-article="{{ $project ->article_diamond_equal_40x50 }}">
                <div>
